...
## [ONE v3.5.0 之前版本：API 链接](ONE~v3.5.0.md) ##

## [ONE v3.5.0 之后版本：API 链接](ONEv3.5.0~.md) ##
...
## [开眼 Eyepetizer：API 链接](Eyepetizer.md)
...
## [金山词典：API 链接](KingsoftDic.md) ##

金山词典链接：[http://www.iciba.com/](http://www.iciba.com/)

## [豆瓣电影：API 链接](DoubanMovie.md) ##
...
## [中央天气预报：API 链接](CenterWeather.md) ##
...
## [魅族天气：API 链接](MXWeather.md) ##

![](http://p1.bpimg.com/4851/4fe7a2df33d616b0.png)

## [OPPO 天气：API 链接](OPPOWeather.md) ##

## [每日一文：API 链接](OneArticle.md) ##
